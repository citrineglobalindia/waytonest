...
import { useContactLeads, useUpdateContactLeadStatus } from "@/hooks/useLeads";
...
const AdminContactLeads = () => {
  ...
  const updateStatus = useUpdateContactLeadStatus();
      ...
      <div className="space-y-6">
        ...
        {isLoading ? (
          ...
          <div className="text-center py-16">
            ...
            <h3 className="text-xl font-semibold text-foreground mb-2">No contact leads yet</h3>
